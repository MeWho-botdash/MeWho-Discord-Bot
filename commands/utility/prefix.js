    ...
    run: async (bot, message, args) => {
     ...
     if(!message.member.hasPermission("MANAGE_GUILD")) {
            ...
            if(option.toLowerCase() === "reset") {
                ...
                return await message.channel.send("Reseted Prefix <:MW_checkmark:884078036734074880>")
            }
          ...
          await message.channel.send(`Done <:MW_checkmark:884078036734074880> | Bot Prefix Set to ${args[0]}`)
